...
public class Title {
	...
	private static void loadClasses() {
		...
		packetActions = getNMSClass(new String[]{
				"EnumTitleAction",
				"PacketPlayOutTitle$EnumTitleAction"
		});
		chatBaseComponent = getNMSClass("IChatBaseComponent");
		nmsChatSerializer = getNMSClass(new String[]{
				"ChatSerializer",
	...
	private static Class<?> getNMSClass(String[] classNames){
		Class<?> clazz = null;
		...
		if(clazz == null){
			System.err.print(Arrays.toString(classNames)+" Not found!");
		}
		return clazz;
	}
